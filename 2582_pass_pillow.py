...
def passThePillow(n, time):
    ...
    # Initialize the list to store the sequence of people passing the pillow
    people = []

    # Append the sequence from 1 to n
    for i in range(n):
        people.append(i + 1)

    # Append the sequence from n-1 to 1 to simulate the return pass
